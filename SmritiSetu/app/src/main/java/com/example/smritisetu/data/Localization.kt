...
val EnglishStrings = AppStrings(
    ...
    timesUp = "Time's Up!",
    timesUpSubtitle = "Take a breath and try again at your own relaxed pace.",
    tryAgain = "Try Again",
...
val AssameseStrings = AppStrings(
    ...
    timesUpSubtitle = "একো নাই, শান্ত হৈ পুনৰ চেষ্টা কৰক।",
...
val HindiStrings = AppStrings(
    ...
    timesUp = "समय समाप्त!",
    timesUpSubtitle = "कोई बात नहीं, आराम से फिर से प्रयास करें।",
...
val BengaliStrings = AppStrings(
    ...
    timesUp = "সময় শেষ!",
    timesUpSubtitle = "চিন্তা নেই, শান্তভাবে আবার চেষ্টা করুন।",
...
val BodoStrings = AppStrings(
    ...
    timesUp = "सम जोबबाय!",
    timesUpSubtitle = "जेबो जाया, फिन गोजोनै नाजा।",
    tryAgain = "फिन नाजा",
    coinsReward = "+२०० खइन",
    xpReward = "+१५ XP",
    ...
    difficultyEasy = "गोरलै",
    difficultyNormal = "साधारण",
    difficultyHard = "गोब्राब",
